...
class Data8(object):
    ...
    Attributes:
        surveys (list of Survey): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        surveys = None
        if dictionary.get('surveys') is not None:
            surveys = [Survey.from_dictionary(x) for x in dictionary.get('surveys')]

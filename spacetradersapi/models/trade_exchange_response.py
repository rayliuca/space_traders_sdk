...
class TradeExchangeResponse(object):

    """Implementation of the 'Trade Exchange Response' model.

    TODO: type model description here.

    Attributes:
        data (list of MarketTrade): TODO: type description here.
    ...
    def __init__(self,
                 data=None,
                 meta=None):
        """Constructor for the TradeExchangeResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [MarketTrade.from_dictionary(x) for x in dictionary.get('data')]

...
class MyShipsJumpRequest(object):

    """Implementation of the 'My Ships Jump Request' model.

    TODO: type model description here.

    Attributes:
        destination (string): The system symbol to jump to.
    ...
    def __init__(self,
                 destination=None):
        """Constructor for the MyShipsJumpRequest class"""

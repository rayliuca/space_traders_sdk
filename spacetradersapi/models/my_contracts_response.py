...
class MyContractsResponse(object):

    """Implementation of the 'My Contracts Response' model.

    TODO: type model description here.

    Attributes:
        data (list of Contract): TODO: type description here.
    ...
    def __init__(self,
                 data=None,
                 meta=None):
        """Constructor for the MyContractsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Contract.from_dictionary(x) for x in dictionary.get('data')]

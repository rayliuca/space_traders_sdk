...
class MyShipsResponse1(object):

    """Implementation of the 'My Ships Response1' model.

    TODO: type model description here.

    Attributes:
        data (list of Ship): TODO: type description here.
    ...
    def __init__(self,
                 data=None,
                 meta=None):
        """Constructor for the MyShipsResponse1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Ship.from_dictionary(x) for x in dictionary.get('data')]
